...
export class BillingController {
  ...
  async getBillingTemplatePreview(@Request() req, @Res() res: Response) {
    ...
    const clinicMeta = [
      ...
      // See pdf.service.ts's generateInvoicePdf for why this is "PAN/VAT"
      // rather than just "VAT" — keeps the live preview in sync with the
...
<style>
  ...
  <div class="footer">
    ...
    ${showVat && clinic.vatNumber          ? `&bull; PAN/VAT: ${clinic.vatNumber}`           : ''}
